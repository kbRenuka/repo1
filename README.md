...
![](https://github.com/kbRenuka/repo1/actions/workflows/1-preparing.yml/badge.svg)
![](https://github.com/kbRenuka/repo1/actions/workflows/2-first-introduction.yml/badge.svg)
![](https://github.com/kbRenuka/repo1/actions/workflows/3-copilot-edits.yml/badge.svg)
![](https://github.com/kbRenuka/repo1/actions/workflows/4-copilot-on-github.yml/badge.svg)
...
2. In the new tab, most of the fields will automatically fill in for you.
   ...
   - We recommend creating a public repository, as private repositories will use [Actions minutes](https://docs.github.chttps://github.com/kbRenuka/repo1/billing/managing-billing-for-github-actions/about-billing-for-github-actions).
...
4. Click **Start Exercise**. Follow the step-by-step instructions and feedback will be provided as you progress.
   ...
   <a id="start-exercise" href="https://github.com/kbRenuka/repo1/issues/1">
